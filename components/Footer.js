    ...
    <footer>
        ...
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          <div className="w-full text-left">
            ...
            <p className="py-3 leading-loose">
              We hope you are making progress on your project... Feel free to
              read the latest news about Strapi. We are giving our best to
            ...
            <ul className="py-3">
              {load ? (
                categories.map((category) => (
                  <li className="py-1" key={`cn-${category.id}`}>
                    <Link
      ...
      <section className="w-full border-t border-borderColor flex justify-center bg-title">
        <p className="text-white py-5">
          © TheCodeGiant | Powered by Next.js, Strapi
        </p>
      </section>
    </footer>
  );
