export default function Privacy() {
  return (
    <div className="privacy sm:container sm:mx-auto">
      <h2 className="text-center">
        <b>PRIVACY POLICY</b>
      </h2>
      <p>Effective date: 2021-05-22</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b> Mitch Cumm</b>.
      </p>
      <p>
        <b>Mitch Cumm</b> (“us”, “we”, or “our”) operates{" "}
        <b>https://MitchCumm.com</b> (hereinafter referred to as{" "}
        <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>https://MitchCumm.com</b>,
      ...
      <p>
        <b>SERVICE</b> means the https://MitchCumm.com website operated by Mitch
        Cumm.
      </p>
      <p>
      ...
      <p>Mitch Cumm uses the collected data for various purposes:</p>
      ...
      <p>
        Mitch Cumm will take all the steps reasonably necessary to ensure that
      ...
      <p>
        ...
        please send your request(s) by email: <b>Mitchcumm@gmail.com</b>.
      </p>
      <p>
      ...
      <p>
        ...
        by email: <b>Mitchcumm@gmail.com</b>.
      </p>
    </div>
  );
}
